...
namespace Kata.Spec
{
    ...
    public class when_input_is_single_number

    {
        ...
        It should_return_the_same = () => { _result.Should().Be(3); };
    ...
    public class when_input_has_breakline
    ...
    public class when_input_has_negative

    {

        Establish _context = () => { _systemUnderTest = new Calculator(); };

        private Because of = () => { _result = Catch.Exception(() => _systemUnderTest.Add("5,2;-2")); };

        It should_thorw_exception = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        private static Calculator _systemUnderTest;
